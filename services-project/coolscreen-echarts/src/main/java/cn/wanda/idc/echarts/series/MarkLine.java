...
import cn.wanda.idc.echarts.style.ItemStyle;
...
public class MarkLine extends AbstractData<MarkLine> {
     ...
     *
     * @see cn.wanda.idc.echarts.series.Series#symbolSize
     */
    private Object symbolSize;
    /**
     * 标线起始和结束的symbol旋转控制，同series中的symbolRotate
     *
     * @see cn.wanda.idc.echarts.series.Series#symbolRoate
     */
    private Object symbolRoate;
    /**
     * 标线图形炫光特效
     *
     * @see cn.wanda.idc.echarts.series.Effect
     */
    private Effect effect;
    /**
     * 标线图形样式属性
     *
     * @see cn.wanda.idc.echarts.style.ItemStyle
     * @see cn.wanda.idc.echarts.series.Series#itemStyle
     */
    private ItemStyle itemStyle;
    /**
     * 地图特有，标线图形定位坐标
     *
     * @see cn.wanda.idc.echarts.series.Map#geoCoord
     */
