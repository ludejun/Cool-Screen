...
export default class BgGradualHeight extends Component {
  constructor(props) {
    super(props);
  }
  render() {
      ...
      >
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          ...
          >
            ...
            <animate attributeName="height" values="0%;43%;0%" dur="3s" repeatCount="indefinite" />
          </rect>
          <rect id="Rectangle-58-Copy" fillOpacity="0.731657609" fill="#3B9EEB" x="1798" width="14">
            <animate attributeName="y" values="50%;29%;50%" dur="3s" repeatCount="indefinite" />
            <animate attributeName="height" values="0%;43%;0%" dur="3s" repeatCount="indefinite" />
          </rect>
          <polygon
