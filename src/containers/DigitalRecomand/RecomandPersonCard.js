  ...
  constructor() {
    ...
    this.typelist = {
      blue: {
        ...
        name: '客户1',
        cardInfo: ['性别：女', '年龄：20～25', '爱好品牌：', '亦谷', 'C&A']
      },
      red: {
        ...
        name: '客户2',
        cardInfo: ['性别：男', '年龄：20～30', '爱好品牌：', 'CK Jeans', 'C&A']
      }
    };
  }
  render() {
    ...
    return (
      ...
      >
        <defs>
          ...
          {/*
          <linearGradient x1="50%" y1="0%" x2="50%" y2="82.5600421%" id={`card-linearGradient-5-${type}`}>
        ...
        */}
          ...
          <path
            ...
            id="info-icon"
            fill={`url(#card-linearGradient-6-${type})`}
            fillRule="nonzero"
          />
