                ...
                <g>
                  <g>
                    ...
                    <polyline
                      ...
                      stroke="#2E5DDD"
                      strokeWidth="6"
                      points={`20,${this.state.leftHeight - 40} 20,${this.state
                        .leftHeight - 10} 50,${this.state.leftHeight - 10}`}
                    />
                  </g>
                </g>
              </g>
                ...
                <g transform="translate(-79.000000, -219.000000)">
                  <g transform="translate(79.000000, 219.000000)">
                            ...
                            <g key={index + Math.random()}>
                              ...
                              {flagX > 0
                                ...
                                : <text
                                  ...
                                  y={
                                    flagY > 0
                                      ? y + flagY * 30 + flagY * ySpan - 60
                                      : y + flagY * 30 + flagY * ySpan + 35
                                  }
                                >
                                  {this.reverseArray[index].content}
                                </text>}
                              {flagX > 0
                                ...
                                : <text
                                  ...
                                  y={
                                    flagY > 0
                                      ? y + flagY * 30 + flagY * ySpan - 10
                                      : y + flagY * 30 + flagY * ySpan + 90
                                  }
                                >{`${this.reverseArray[index].percent *
                                100}%`}</text>}
                            </g>
                    ...
                    >
                      ...
                      <circle id="Oval-50-Copy-2" cx="32.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-3" cx="47.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-4" cx="62.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-6" cx="77.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-5" cx="92.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-7" cx="107.5" cy="2.5" r="2.5" />
                      <circle id="Oval-50-Copy-8" cx="122.5" cy="2.5" r="2.5" />
                      <circle
                        id="Oval-50-Copy-10"
                        cx="137.5"
                        cy="2.5"
                        r="2.5"
                      />
                      <circle id="Oval-50-Copy-9" cx="152.5" cy="2.5" r="2.5" />
                      <circle
                        id="Oval-50-Copy-11"
                        cx="167.5"
                        cy="2.5"
                ...
                <div className="layer-svg">
                  ...
                  >
                    <defs>
                      ...
                      <polygon
                        id="jin-path-2"
                        points="0 63.3539325 23.6345184 77.1339279 50 61.8061628 26.2735419 48"
                      />
                      <filter
                        x="-30.0%"
                        y="-50.0%"
                      ...
                      >
                        <feGaussianBlur
                          stdDeviation="1.26953125"
                          in="SourceGraphic"
                        />
                      </filter>
                      <polygon
                        id="jin-path-5"
                        points="358 218.283146 376.907615 229.307142 398 217.04493 379.018833 206"
                      />
                      <filter
                        x="-37.5%"
                        y="-62.6%"
                      ...
                      <polygon
                        id="jin-path-8"
                        points="204.105799 21.4959943 17.1013584 128.360327 194.070707 229.777081 380.605886 122.665535"
                      />
                      <filter
                        x="-4.1%"
                        y="-7.0%"
                      ...
                      >
                        <stop
                          stopColor="#061442"
                          stopOpacity="0.483582428"
                          offset="0%"
                        />
                        <stop
                          stopColor="#061442"
                          stopOpacity="0.35657269"
                          offset="56.5713877%"
                        />
                        <stop stopColor="#061442" stopOpacity="0" offset="100%" />
                      </linearGradient>
                      <filter
                        x="-4.2%"
                        y="-9.4%"
                      ...
                      >
                        <stop stopColor="#032739" offset="0%" />
                        <stop stopColor="#044869" offset="100%" />
                      </linearGradient>
                      <filter
                        x="-18.5%"
                        y="-37.1%"
                      ...
                      >
                        <stop stopColor="#80EBFD" offset="0%" />
                        <stop stopColor="#1D5EDE" offset="100%" />
                      </linearGradient>
                      <filter
                        x="-50.2%"
                        y="-100.4%"
                      ...
                      >
                        <stop stopColor="#3AC5FC" offset="0%" />
                        <stop stopColor="#1349A6" offset="46.0758131%" />
                        <stop stopColor="#1349A6" offset="47.5199132%" />
                        <stop stopColor="#103992" offset="100%" />
                      </linearGradient>
                      <linearGradient
                        x1="50%"
                        y1="0%"
                      ...
                      >
                        <stop stopColor="#0B7C97" offset="0%" />
                        <stop stopColor="#1DCBFB" offset="51.6165716%" />
                        <stop stopColor="#085985" offset="100%" />
                      </linearGradient>
                      <linearGradient
                        x1="77.4778792%"
                        y1="0%"
                      ...
                      >
                        <stop stopColor="#3AE6FC" offset="0%" />
                        <stop stopColor="#096C94" offset="46.0758131%" />
                        <stop stopColor="#104792" offset="100%" />
                      </linearGradient>
                      <path
                      ...
                      >
                        <stop stopColor="#79EAFF" offset="0%" />
                        <stop stopColor="#42CFFF" offset="100%" />
                      </linearGradient>
                      <linearGradient
                        x1="100%"
                        y1="0%"
                      ...
                      >
                        <stop stopColor="#0B4083" offset="0%" />
                        <stop stopColor="#3488EF" offset="100%" />
                      </linearGradient>
                      <path
                      ...
                      <linearGradient
                        ...
                        x2="50%"
                        y2="100%"
                        id="jin-linearGradient-37"
                      >
                        <stop stopColor="#37BBF6" offset="0%" />
                        <stop stopColor="#13439E" offset="100%" />
                      </linearGradient>
                      <path
                      ...
                      >
                        <stop stopColor="#80EBFD" offset="0%" />
                        <stop stopColor="#248EEF" offset="100%" />
                      </linearGradient>
                      <path
                    ...
                    >
                      <g
                        id="数字金融-期望划分"
                        transform="translate(-1403.000000, -688.000000)"
                      >
                        <g
                          id="q&amp;a"
                          transform="translate(1404.000000, 688.000000)"
                        >
                          <g id="Group-3">
                            <g id="Group-23">
                              <g
                              ...
                              <g
                                id="Group-20"
                                transform="translate(375.000000, 170.000000)"
                              >
                                <polygon
                                  id="Path-60"
                                  fill="#0D2B7E"
                                  points="1.05277897 1.70447754 2.04030632 0.721386284 2.70559192 2.39988715 2.36726874 3.01562403"
                                />
                                <polygon
                                  id="Path-61"
                                  fill="#0D2B7E"
                                  points="4.74118385 26.5687962 5.70866943 25.4715777 4.86116563 23.6967236 3.99529005 24.376479"
                                />
                                <g id="！">
                                  <use
                                    fill="black"
                              ...
                              >
                                <g id="Group-19">
                                  <polygon
                                    id="Path-58"
                                    fill="#0D2B7E"
                                    points="0.0200724664 16.4700895 1.02718638 17.462826 1.58968296 15.9337969 1.09489931 14.8663907"
                                  />
                                  <polygon
                                    id="Path-59"
                                    fill="#0D2B7E"
                                    points="6.24200969 25.5154086 7.19640646 26.4837963 7.85993135 24.4654717 7.27138539 24.1197183"
                                  />
                                  <g id="？">
                                    <use
                                      fill="black"
                              ...
                              <polygon
                                ...
                                fill="#1C50B9"
                                points="204.45 31.795 341.270823 111.220942 193.878875 196.232065 58.124038 116.653317"
                              />
                              <polygon
                                id="Path-54"
                                fill="#3ABDFC"
                                points="341.280074 111.203695 341.280074 117.489464 193.883588 201.981336 193.883588 196.239296"
                              />
                              <polygon
                                id="Path-938"
                                fill="#062973"
                                points="58.2964026 116.750218 58.2964026 123.531564 193.980003 201.960286 193.980003 196.253853"
                              />
                              <polygon
                                id="Path-62"
                                fill="url(#jin-linearGradient-14)"
                                filter="url(#jin-filter-15)"
                                points="169.574177 85.367777 135.386283 99.8496359 68.730114 122.629787 62.3109831 114.910769 145.058344 74.824127 156.341881 74.4654267"
                              />
                              <polygon
                                id="Path-63"
                                ...
                                points="197.806108 138.411023 189.306481 140.728623 160.900552 124.76172 168.142836 122.360497"
                              />
                              <g id="Group-17" className="a-animation">
                                <polyline
                                  id="Fill-4"
                                  fill="#3ABDFC"
                                  points="19.295 67.344 28.065 63.135 23.293 77.448 14.523 81.657 19.295 67.344"
                                />
                                <polyline
                                  id="Fill-5"
                                  fill="#7EF2FF"
                                  points="23.295 55.343 32.065 51.134 48.98 60.9 40.21 65.108 23.295 55.343"
                                />
                                <polyline
                                  id="Fill-6"
                                  fill="#3ABDFC"
                                  points="32.427 27.939 41.196 23.73 32.065 51.134 23.295 55.343 32.427 27.939"
                                />
                                <path
                                  ...
                                  id="Fill-7"
                                  fill="url(#jin-linearGradient-22)"
                                />
                                <polyline
                                  id="Fill-8"
                                  fill="#3ABDFC"
                                  points="40.708 13.729 49.478 9.521 71.415 105.231 62.646 109.44 40.708 13.729"
                                />
                                <polyline
                                  id="Fill-9"
                                  fill="#7EF2FF"
                                  points="25.096 4.715 33.865 0.507 49.478 9.521 40.708 13.729 25.096 4.715"
                                />
                              </g>
                              <g
                                id="Group-18"
                                transform="translate(167.000000, 63.000000)"
                              >
                                <polygon
                                  id="Path-55"
                                  fillOpacity="0.840268342"
                                  fill="#1FC6E8"
                                  points="0 55.2295395 29.5289571 38 58.9810363 55.1458629 29.5221584 71.7541035"
                                />
                                <ellipse
                                  id="Oval-8"
                                  fill="#0D5E75"
                                ...
                                >
                                  <polyline
                                    id="Fill-59"
                                    fill="#686968"
                                    points="26.683 35.866 20.837 33.06 18.731 31.14 24.577 33.946 26.683 35.866"
                                  />
                                  <g
                                    id="Group-65"
                                    transform="translate(13.000000, 28.000000)"
                                    fill="#094D76"
                                  >
                                    <path
                                  ...
                                  >
                                    <mask id="mask-25" fill="white">
                                      <use xlinkHref="#jin-path-24" />
                                    </mask>
                                    <use
                                      id="Clip-67"
                                      fill="#0B5988"
                                      xlinkHref="#jin-path-24"
                                    />
                                  </g>
                                  <polyline
                                    id="Fill-75"
                                    fill="#23F9FE"
                                    points="26.211 16.985 20.365 14.18 25.426 11.258 31.272 14.063 26.211 16.985"
                                  />
                                  <g
                                    id="Group-87"
                                    transform="translate(8.000000, 31.000000)"
                                  >
                                    <mask id="mask-27" fill="white">
                                      <use xlinkHref="#jin-path-26" />
                                    </mask>
                                    <use
                                      id="Clip-77"
                                      fill="#094D76"
                                      xlinkHref="#jin-path-26"
                                    />
                                  </g>
                                  <path
                                  ...
                                  >
                                    <mask id="mask-32" fill="white">
                                      <use xlinkHref="#jin-path-31" />
                                    </mask>
                                    <use
                                      id="Clip-122"
                                      fill="url(#jin-linearGradient-30)"
                                      xlinkHref="#jin-path-31"
                                    />
                                  </g>
                                  <path
                                    ...
                                    id="Fill-145"
                                    fill="url(#jin-linearGradient-33)"
                                  />
                                </g>
                                <polygon
                                  id="Path-56"
                                  fill="#3AE9FC"
                                  points="58.9914645 55.1284836 58.9914645 58.7828362 29.5371597 75.5825384 29.5371597 71.7400251"
                                />
                                <polygon
                                  id="Path-57"
                                  fill="#044869"
                                  points="0.0157726584 55.2631886 0.0157726584 59.4920614 29.5285995 75.5512631 29.5285995 71.7636695"
                                />
                              </g>
                              <g
                                className="q-animation"
                                id="Group-16"
                              ...
                              >
                                <polyline
                                  id="Fill-10"
                                  fill="#0D347A"
                                  points="66.991 85.38 58.221 81.172 50.123 76.379 58.892 80.588 66.991 85.38"
                                />
                                <g
                                  id="Group-15"
                                  transform="translate(47.000000, 49.000000)"
                                />
                                <polyline
                                  id="Fill-16"
                                  fill="#0D347A"
                                  points="49.439 74.971 40.669 70.762 33.843 66.702 42.612 70.911 49.439 74.971"
                                />
                                <g
                                  id="Group-28"
                                  transform="translate(22.000000, 70.000000)"
                                >
                                  <mask id="mask-36" fill="white">
                                    <use xlinkHref="#jin-path-35" />
                                  </mask>
                                  <use
                                    id="Clip-19"
                                    fill="url(#jin-linearGradient-34)"
                                    xlinkHref="#jin-path-35"
                                  />
                                </g>
                                <g
                                  id="Group-33"
                                  transform="translate(47.000000, 20.000000)"
                                >
                                  <mask id="mask-39" fill="white">
                                    <use xlinkHref="#jin-path-38" />
                                  </mask>
                                  <use
                                    id="Clip-30"
                                    fill="url(#jin-linearGradient-37)"
                                    xlinkHref="#jin-path-38"
                                  />
                                </g>
                                <path
                                  ...
                                  id="Fill-34"
                                  fill="url(#jin-linearGradient-40)"
                                />
                                <g id="Group-58">
                                  <mask id="mask-42" fill="white">
                                    <use xlinkHref="#jin-path-41" />
                                  </mask>
                                  <use
                                    id="Clip-36"
                                    fill="url(#jin-linearGradient-28)"
                                    xlinkHref="#jin-path-41"
                                  />
                                </g>
                                <polyline
                                  id="Fill-17"
                                  fill="#1C61DE"
                                  points="42.612 70.911 33.843 66.702 40.776 53.393 49.546 57.602 42.612 70.911"
                                />
                              </g>
                              <polyline
                                className="line-move"
                                id="Path-942"
                                stroke="#215AD2"
                                points="156.07656 95.274665 174.904063 106.39552 146.94551 122.651149 195.043145 150.532777 242.376654 122.662688 223.301708 111.277722 263.151653 88.861647"
                              />
                              <polyline
                                className="line-move"
                                id="Path-66"
                                stroke="#215AD2"
                                points="159.218488 115.995 146.311046 108.466709 113.520699 127.259768 149.23302 148.171556 169.214943 135.796582"
                              />
                            </g>
                          </g>
                        </g>
