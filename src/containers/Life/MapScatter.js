...
const mapList = [{img:'/img/beijing-tab.png',city:'北京市', name:'beijing', data:'',position1:'top-left', position:'left'},
	{img:'/img/shanghai-tab.png',city:'上海市', name:'shanghai', data:'',position1:'top-right', position:'right'},
	{img:'/img/guangzhou-tab.png',city:'广州市', name:'guangzhou', data:'',position1:'bottom-right', position:'right'},
];
