    ...
    return (
      <div className="parking-contariner-f">
        ...
        <div className="parking-right">
          <div className="right-layout1 right-layout">
            <svg
              className="svg-lay"
              viewBox="0 0 704 172"
              version="1.1"
            ...
            <div className="right-content">
              <div className="content">
                ...
                <div className="second-content">
                  <ul>
                    {carModel && carModel[1].model.map((model, index) => (
                      <li key={index}>
          ...
          <div className="right-layout2 right-layout">
            ...
            <div className="middle-content">
              <div className="content">
                ...
                <div className="second-content">
                  <div className="content-column">
                    <div className="text">92%</div>
                    <div>
                      <img width="32" height="42" className="img-svg" src="/img/money.svg"></img>
                    </div>
                    <div className="text">穗牌</div>
                  </div>
                  <div className="content-column">
            ...
            <div className="right-content">
              <div className="content">
                ...
                <div className="second-content">
                  <ul>
                    {carModel && carModel[2].model.map((model, index) => (
                      <li key={index}>
                        <div className="content-number">
                          <div className="level-img"><img src={`/img/level${index+1}.png`} /></div>
                          <div className="car-img"><img src={`/img/car${index+1}.png`} /></div>
          ...
          <div className="right-layout3 right-layout">
            ...
            <div className="right-content">
              <div className="content">
                ...
                <div className="second-content">
                  <ul>
                    {carModel && carModel[0].model.map((model, index) => (
                      <li key={index}>
                        <div className="content-number">
                          <div className="level-img"><img src={`/img/level${index+1}.png`} /></div>
                          <div className="car-img"><img src={`/img/car${index+1}.png`} /></div>
