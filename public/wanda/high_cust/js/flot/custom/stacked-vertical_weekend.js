...
$(function () {
	...
	var d1, d2, d3, data, chartOptions;
        ...
        $.get('/query/cust_data', {id: 'high_cust_ratio_h_67'},  function(d1){
                $.get('/query/cust_data', {id: 'med_cust_ratio_h_67'},  function(d2){
                        $.get('/query/cust_data', {id: 'low_cust_ratio_h_67'},  function(d3){
