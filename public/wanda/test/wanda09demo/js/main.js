...
workPlaces = {
	zhongguancun: {
		...
		//轨迹粗细
		lineWidth: 0.1,
		center: new BMap.Point(116.318247, 39.986398),
...
/* ----------------------------------------------------------
 ...
 并绑定地图拖拽，同步到蒙层位置
 */
map.centerAndZoom(workPlaces.zhongguancun.center, 12),
...
var keyIndex = 0, keyDelay = 30000, keyHandle = 0;
function autoRun(){
	clearTimeout(keyHandle);
	keyHandle = setTimeout(autoRun, keyDelay);
