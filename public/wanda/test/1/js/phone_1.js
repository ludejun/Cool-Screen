...
(function(){
    ...
    p.initLoader = function()
    {
        var cur = this;
        var resourcesAry = [
            {id:"title", type:"texture", url:"img/title.png"},
            {id:"dotCir", type:"texture", url:"img/dotCir.png"},
            {id:"arrowCir", type:"texture", url:"img/arrowCir.png"},
            {id:"dateMC", type:"texture", url:"img/dateMC.png"},
            {id:"spark", type:"texture", url:"img/spark1.png"}
        ];
