...
TrafficLayer.prototype.request = function(t) {
	...
	var i = this;
	$(".loading").show();
	var a = "assets/cust_source/data/" + t;
	isMobile() && (a += "_min"),
	a += ".js",
	$.ajax({
		url: a,
...
TrafficLayer.prototype.drawLines = function(t, i, a, e, s) {
	...
	if (t) {
		var o = map.getZoom();
		var h = Math.pow(2, 18 - o);
		// var R = this.mercatorProjection.lngLatToPoint(workPlaces[this.T].center);
		// var C = new BMap.Pixel(R.x - n.canvas.width / 2 * h, R.y + n.canvas.height / 2 * h);
		n.beginPath();
...
TrafficLayer.prototype.drawLinesAni = function(t) {
	...
	o = 500;
	isMobile() && (o = 80);
	for (var h = 0; o > h; h++) n&&n[h]&&(n[h][3] = 1);
...
TrafficLayer.prototype._drawAnimateMarker = function(t) {
	...
	if (i && this._data[t]) {
		...
		a.save(),
		a.beginPath(),
		a.strokeStyle = "rgba(255,255,255,0.9)", //中间放射圆形颜色
		circleSize += 1,
